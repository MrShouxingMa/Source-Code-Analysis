...
def ParseArgs():
    ...
    parser.add_argument('--d_emb_size', type=int, default=10, help='time step dimension size')
    parser.add_argument('--norm', type=bool, default=False)
    parser.add_argument('--steps', type=int, default=5, help='time step number')
    ...
    parser.add_argument('--e_loss', type=float, default=0.1,
                        help='Weighting coefficient for signal injection in Equation 24, lamda_0')
